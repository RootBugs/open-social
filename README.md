<!-- // audit: add_import — transformAudit -->
This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).  <!-- refactored logic call -->  <!-- refactored decode call -->
...
<!-- // metric: add_interface — fetchMetric -->
